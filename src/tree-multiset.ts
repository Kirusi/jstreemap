...
export class TreeMultiSet<K> {
   ...
   * @param {*} callback - The same type of callback as used in `forEach` of standard JS maps
   * @example
   * let set = new TreeMultiSet([1, 2, 3]);
   ...
   * @param {K} key - New key to be added
   * @example
   * let set = new TreeMultiSet();
   * set.add(1);
   * set.add(1);
   ...
   * @returns {SetIterator} forward iterator pointing to the first node
   * @example
   * let set = new TreeMultiSet();
   * ...
   ...
   * @returns {SetIterator} forward iterator pointing to the node after the last element
   * @example
   * let set = new TreeMultiSet();
   * ...
   * for (let it = set.begin(); !it.equals(set.end()); it.next()) {
   ...
   * @returns {SetIterator} iterator pointing to found node
   * @example
   * let set = new TreeMultiSet([1, 2, 3]);
   * ...
   * let it = set.find(1);
   ...
   * @param {SetIterator} iterator - Iterator pointing at the node to be removed
   * @example
   * let set = new TreeMultiSet([1,2,3]);
   * let it = set.find(2);
   * it.prev();
   ...
   * @returns {K | undefined} first element of the container, or undefined if container is empty
   * @example
   * let set = new TreeMultiSet([1, 2, 3]);
   ...
   * @returns {K | undefined} last element of the container, or undefined if container is empty
   * @example
   * let set = new TreeMultiSet([1, 2, 3]);
   * let last = set.last(); // 3
   */
